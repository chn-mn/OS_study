...
80100028:	bc d0 f5 10 80       	mov    $0x8010f5d0,%esp
...
80100044:	bb 14 f6 10 80       	mov    $0x8010f614,%ebx
{
80100049:	83 ec 0c             	sub    $0xc,%esp
  initlock(&bcache.lock, "bcache");
8010004c:	68 e0 6f 10 80       	push   $0x80106fe0
80100051:	68 e0 f5 10 80       	push   $0x8010f5e0
80100056:	e8 b5 42 00 00       	call   80104310 <initlock>
  bcache.head.prev = &bcache.head;
8010005b:	c7 05 2c 3d 11 80 dc 	movl   $0x80113cdc,0x80113d2c
80100062:	3c 11 80 
  bcache.head.next = &bcache.head;
80100065:	c7 05 30 3d 11 80 dc 	movl   $0x80113cdc,0x80113d30
8010006c:	3c 11 80 
8010006f:	83 c4 10             	add    $0x10,%esp
80100072:	ba dc 3c 11 80       	mov    $0x80113cdc,%edx
...
801000b0:	89 1d 30 3d 11 80    	mov    %ebx,0x80113d30
  for(b = bcache.buf; b < bcache.buf+NBUF; b++){
801000b6:	3d dc 3c 11 80       	cmp    $0x80113cdc,%eax
...
801000dc:	8b 7d 0c             	mov    0xc(%ebp),%edi
  acquire(&bcache.lock);
801000df:	68 e0 f5 10 80       	push   $0x8010f5e0
801000e4:	e8 67 43 00 00       	call   80104450 <acquire>
  for(b = bcache.head.next; b != &bcache.head; b = b->next){
801000e9:	8b 1d 30 3d 11 80    	mov    0x80113d30,%ebx
801000ef:	83 c4 10             	add    $0x10,%esp
801000f2:	81 fb dc 3c 11 80    	cmp    $0x80113cdc,%ebx
...
801001ff:	e8 7c 40 00 00       	call   80104280 <releasesleep>
  ...
  acquire(&bcache.lock);
80100204:	c7 04 24 e0 f5 10 80 	movl   $0x8010f5e0,(%esp)
...
8010022f:	89 50 54             	mov    %edx,0x54(%eax)
    b->next = bcache.head.next;
80100232:	a1 30 3d 11 80       	mov    0x80113d30,%eax
    b->prev = &bcache.head;
80100237:	c7 43 50 dc 3c 11 80 	movl   $0x80113cdc,0x50(%ebx)
    b->next = bcache.head.next;
8010023e:	89 43 54             	mov    %eax,0x54(%ebx)
    bcache.head.next->prev = b;
80100241:	a1 30 3d 11 80       	mov    0x80113d30,%eax
80100246:	89 58 50             	mov    %ebx,0x50(%eax)
    bcache.head.next = b;
80100249:	89 1d 30 3d 11 80    	mov    %ebx,0x80113d30
  }
  
  release(&bcache.lock);
8010024f:	c7 45 08 e0 f5 10 80 	movl   $0x8010f5e0,0x8(%ebp)
}
...
801002a1:	8b 15 c0 3f 11 80    	mov    0x80113fc0,%edx
801002a7:	39 15 c4 3f 11 80    	cmp    %edx,0x80113fc4
...
801002c0:	68 c0 3f 11 80       	push   $0x80113fc0
801002c5:	e8 a6 3b 00 00       	call   80103e70 <sleep>
    while(input.r == input.w){
801002ca:	8b 15 c0 3f 11 80    	mov    0x80113fc0,%edx
801002d0:	83 c4 10             	add    $0x10,%esp
801002d3:	3b 15 c4 3f 11 80    	cmp    0x80113fc4,%edx
...
80100313:	a3 c0 3f 11 80       	mov    %eax,0x80113fc0
80100318:	89 d0                	mov    %edx,%eax
8010031a:	83 e0 7f             	and    $0x7f,%eax
8010031d:	0f be 80 40 3f 11 80 	movsbl -0x7feec0c0(%eax),%eax
    if(c == C('D')){  // EOF
...
80100370:	73 d0                	jae    80100342 <consoleread+0xd2>
        input.r--;
80100372:	89 15 c0 3f 11 80    	mov    %edx,0x80113fc0
...
8010084f:	75 54                	jne    801008a5 <consoleintr+0x95>
      if(input.e != input.w){
80100851:	a1 c8 3f 11 80       	mov    0x80113fc8,%eax
80100856:	3b 05 c4 3f 11 80    	cmp    0x80113fc4,%eax
8010085c:	74 d2                	je     80100830 <consoleintr+0x20>
        input.e--;
8010085e:	83 e8 01             	sub    $0x1,%eax
80100861:	a3 c8 3f 11 80       	mov    %eax,0x80113fc8
        consputc(BACKSPACE);
...
801008a9:	a1 c8 3f 11 80       	mov    0x80113fc8,%eax
801008ae:	89 c2                	mov    %eax,%edx
801008b0:	2b 15 c0 3f 11 80    	sub    0x80113fc0,%edx
...
801008c8:	89 15 c8 3f 11 80    	mov    %edx,0x80113fc8
        c = (c == '\r') ? '\n' : c;
801008ce:	0f 84 cc 00 00 00    	je     801009a0 <consoleintr+0x190>
        input.buf[input.e++ % INPUT_BUF] = c;
801008d4:	89 f9                	mov    %edi,%ecx
801008d6:	88 88 40 3f 11 80    	mov    %cl,-0x7feec0c0(%eax)
        consputc(c);
...
801008f5:	a1 c0 3f 11 80       	mov    0x80113fc0,%eax
801008fa:	83 e8 80             	sub    $0xffffff80,%eax
801008fd:	39 05 c8 3f 11 80    	cmp    %eax,0x80113fc8
80100903:	0f 85 27 ff ff ff    	jne    80100830 <consoleintr+0x20>
          wakeup(&input.r);
80100909:	83 ec 0c             	sub    $0xc,%esp
          input.w = input.e;
8010090c:	a3 c4 3f 11 80       	mov    %eax,0x80113fc4
          wakeup(&input.r);
80100911:	68 c0 3f 11 80       	push   $0x80113fc0
...
80100938:	a1 c8 3f 11 80       	mov    0x80113fc8,%eax
8010093d:	39 05 c4 3f 11 80    	cmp    %eax,0x80113fc4
80100943:	75 2b                	jne    80100970 <consoleintr+0x160>
80100945:	e9 e6 fe ff ff       	jmp    80100830 <consoleintr+0x20>
8010094a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        input.e--;
80100950:	a3 c8 3f 11 80       	mov    %eax,0x80113fc8
        consputc(BACKSPACE);
80100955:	b8 00 01 00 00       	mov    $0x100,%eax
8010095a:	e8 b1 fa ff ff       	call   80100410 <consputc>
      while(input.e != input.w &&
8010095f:	a1 c8 3f 11 80       	mov    0x80113fc8,%eax
80100964:	3b 05 c4 3f 11 80    	cmp    0x80113fc4,%eax
...
80100975:	83 e2 7f             	and    $0x7f,%edx
      while(input.e != input.w &&
80100978:	80 ba 40 3f 11 80 0a 	cmpb   $0xa,-0x7feec0c0(%edx)
...
8010099c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
        input.buf[input.e++ % INPUT_BUF] = c;
801009a0:	c6 80 40 3f 11 80 0a 	movb   $0xa,-0x7feec0c0(%eax)
        consputc(c);
801009a7:	b8 0a 00 00 00       	mov    $0xa,%eax
801009ac:	e8 5f fa ff ff       	call   80100410 <consputc>
801009b1:	a1 c8 3f 11 80       	mov    0x80113fc8,%eax
...
801009d9:	6a 01                	push   $0x1
  devsw[CONSOLE].write = consolewrite;
801009db:	c7 05 8c 49 11 80 00 	movl   $0x80100600,0x8011498c
801009e2:	06 10 80 
  devsw[CONSOLE].read = consoleread;
801009e5:	c7 05 88 49 11 80 70 	movl   $0x80100270,0x80114988
801009ec:	02 10 80 
  cons.locking = 1;
...
80100d6b:	68 e0 3f 11 80       	push   $0x80113fe0
...
80100d84:	bb 14 40 11 80       	mov    $0x80114014,%ebx
{
80100d89:	83 ec 10             	sub    $0x10,%esp
  acquire(&ftable.lock);
80100d8c:	68 e0 3f 11 80       	push   $0x80113fe0
...
80100da3:	81 fb 74 49 11 80    	cmp    $0x80114974,%ebx
...
80100db5:	c7 43 04 01 00 00 00 	movl   $0x1,0x4(%ebx)
      release(&ftable.lock);
80100dbc:	68 e0 3f 11 80       	push   $0x80113fe0
...
80100dd3:	31 db                	xor    %ebx,%ebx
  release(&ftable.lock);
80100dd5:	68 e0 3f 11 80       	push   $0x80113fe0
...
80100df7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&ftable.lock);
80100dfa:	68 e0 3f 11 80       	push   $0x80113fe0
...
80100e14:	89 43 04             	mov    %eax,0x4(%ebx)
  release(&ftable.lock);
80100e17:	68 e0 3f 11 80       	push   $0x80113fe0
...
80100e49:	8b 5d 08             	mov    0x8(%ebp),%ebx
  ...
  acquire(&ftable.lock);
80100e4c:	68 e0 3f 11 80       	push   $0x80113fe0
...
80100e6c:	74 1a                	je     80100e88 <fileclose+0x48>
    release(&ftable.lock);
80100e6e:	c7 45 08 e0 3f 11 80 	movl   $0x80113fe0,0x8(%ebp)
...
80100e9d:	8b 43 10             	mov    0x10(%ebx),%eax
  release(&ftable.lock);
80100ea0:	68 e0 3f 11 80       	push   $0x80113fe0
  ff = *f;
...
8010111a:	03 15 f8 49 11 80    	add    0x801149f8,%edx
...
80101189:	8b 0d e0 49 11 80    	mov    0x801149e0,%ecx
{
...
801011ac:	03 05 f8 49 11 80    	add    0x801149f8,%eax
801011b2:	50                   	push   %eax
801011b3:	ff 75 d8             	pushl  -0x28(%ebp)
801011b6:	e8 15 ef ff ff       	call   801000d0 <bread>
801011bb:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    for(bi = 0; bi < BPB && b + bi < sb.size; bi++){
801011be:	a1 e0 49 11 80       	mov    0x801149e0,%eax
...
80101219:	39 05 e0 49 11 80    	cmp    %eax,0x801149e0
...
8010129a:	bb 34 4a 11 80       	mov    $0x80114a34,%ebx
{
8010129f:	83 ec 28             	sub    $0x28,%esp
801012a2:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  acquire(&icache.lock);
801012a5:	68 00 4a 11 80       	push   $0x80114a00
...
801012c6:	81 fb 54 66 11 80    	cmp    $0x80116654,%ebx
...
801012e8:	81 fb 54 66 11 80    	cmp    $0x80116654,%ebx
...
80101303:	c7 46 4c 00 00 00 00 	movl   $0x0,0x4c(%esi)
  release(&icache.lock);
8010130a:	68 00 4a 11 80       	push   $0x80114a00
...
80101333:	89 de                	mov    %ebx,%esi
      release(&icache.lock);
80101335:	68 00 4a 11 80       	push   $0x80114a00
      ip->ref++;
...
80101484:	bb 40 4a 11 80       	mov    $0x80114a40,%ebx
80101489:	83 ec 0c             	sub    $0xc,%esp
  initlock(&icache.lock, "icache");
8010148c:	68 eb 70 10 80       	push   $0x801070eb
80101491:	68 00 4a 11 80       	push   $0x80114a00
...
801014b7:	81 fb 60 66 11 80    	cmp    $0x80116660,%ebx
801014bd:	75 e1                	jne    801014a0 <iinit+0x20>
  readsb(dev, &sb);
801014bf:	83 ec 08             	sub    $0x8,%esp
801014c2:	68 e0 49 11 80       	push   $0x801149e0
801014c7:	ff 75 08             	pushl  0x8(%ebp)
801014ca:	e8 71 ff ff ff       	call   80101440 <readsb>
  cprintf("sb: size %d nblocks %d ninodes %d nlog %d logstart %d\
801014cf:	ff 35 f8 49 11 80    	pushl  0x801149f8
801014d5:	ff 35 f4 49 11 80    	pushl  0x801149f4
801014db:	ff 35 f0 49 11 80    	pushl  0x801149f0
801014e1:	ff 35 ec 49 11 80    	pushl  0x801149ec
801014e7:	ff 35 e8 49 11 80    	pushl  0x801149e8
801014ed:	ff 35 e4 49 11 80    	pushl  0x801149e4
801014f3:	ff 35 e0 49 11 80    	pushl  0x801149e0
...
80101519:	83 3d e8 49 11 80 01 	cmpl   $0x1,0x801149e8
{
...
8010154f:	39 1d e8 49 11 80    	cmp    %ebx,0x801149e8
80101555:	76 69                	jbe    801015c0 <ialloc+0xb0>
    bp = bread(dev, IBLOCK(inum, sb));
80101557:	89 d8                	mov    %ebx,%eax
80101559:	83 ec 08             	sub    $0x8,%esp
8010155c:	c1 e8 03             	shr    $0x3,%eax
8010155f:	03 05 f4 49 11 80    	add    0x801149f4,%eax
...
801015e4:	03 05 f4 49 11 80    	add    0x801149f4,%eax
...
80101657:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&icache.lock);
8010165a:	68 00 4a 11 80       	push   $0x80114a00
8010165f:	e8 ec 2d 00 00       	call   80104450 <acquire>
  ip->ref++;
80101664:	83 43 08 01          	addl   $0x1,0x8(%ebx)
  release(&icache.lock);
80101668:	c7 04 24 00 4a 11 80 	movl   $0x80114a00,(%esp)
...
801016c9:	03 05 f4 49 11 80    	add    0x801149f4,%eax
...
801017da:	e8 a1 2a 00 00       	call   80104280 <releasesleep>
  acquire(&icache.lock);
801017df:	c7 04 24 00 4a 11 80 	movl   $0x80114a00,(%esp)
801017e6:	e8 65 2c 00 00       	call   80104450 <acquire>
  ip->ref--;
801017eb:	83 6b 08 01          	subl   $0x1,0x8(%ebx)
  release(&icache.lock);
801017ef:	83 c4 10             	add    $0x10,%esp
801017f2:	c7 45 08 00 4a 11 80 	movl   $0x80114a00,0x8(%ebp)
}
...
8010180b:	68 00 4a 11 80       	push   $0x80114a00
80101810:	e8 3b 2c 00 00       	call   80104450 <acquire>
    int r = ip->ref;
80101815:	8b 73 08             	mov    0x8(%ebx),%esi
    release(&icache.lock);
80101818:	c7 04 24 00 4a 11 80 	movl   $0x80114a00,(%esp)
...
80101a3a:	8b 04 c5 80 49 11 80 	mov    -0x7feeb680(,%eax,8),%eax
...
80101b4a:	8b 04 c5 84 49 11 80 	mov    -0x7feeb67c(,%eax,8),%eax
...
80101c81:	8b 70 68             	mov    0x68(%eax),%esi
  acquire(&icache.lock);
80101c84:	68 00 4a 11 80       	push   $0x80114a00
80101c89:	e8 c2 27 00 00       	call   80104450 <acquire>
  ip->ref++;
80101c8e:	83 46 08 01          	addl   $0x1,0x8(%esi)
  release(&icache.lock);
80101c92:	c7 04 24 00 4a 11 80 	movl   $0x80114a00,(%esp)
...
80101ec8:	68 42 77 10 80       	push   $0x80107742
...
80102015:	58                   	pop    %eax
80102016:	a1 20 6d 11 80       	mov    0x80116d20,%eax
8010201b:	5a                   	pop    %edx
...
80102221:	c7 05 54 66 11 80 00 	movl   $0xfec00000,0x80116654
80102228:	00 c0 fe 
{
...
80102236:	00 00 00 
  return ioapic->data;
80102239:	a1 54 66 11 80       	mov    0x80116654,%eax
8010223e:	8b 58 10             	mov    0x10(%eax),%ebx
  ioapic->reg = reg;
80102241:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  return ioapic->data;
80102247:	8b 0d 54 66 11 80    	mov    0x80116654,%ecx
  maxintr = (ioapicread(REG_VER) >> 16) & 0xFF;
  id = ioapicread(REG_ID) >> 24;
  if(id != ioapicid)
8010224d:	0f b6 15 80 67 11 80 	movzbl 0x80116780,%edx
  maxintr = (ioapicread(REG_VER) >> 16) & 0xFF;
...
80102271:	8b 0d 54 66 11 80    	mov    0x80116654,%ecx
...
80102290:	89 11                	mov    %edx,(%ecx)
  ioapic->data = data;
80102292:	8b 0d 54 66 11 80    	mov    0x80116654,%ecx
...
801022ae:	89 31                	mov    %esi,(%ecx)
  ioapic->data = data;
801022b0:	8b 0d 54 66 11 80    	mov    0x80116654,%ecx
...
801022d0:	55                   	push   %ebp
  ioapic->reg = reg;
801022d1:	8b 0d 54 66 11 80    	mov    0x80116654,%ecx
{
...
801022e3:	89 01                	mov    %eax,(%ecx)
  ioapic->data = data;
801022e5:	8b 0d 54 66 11 80    	mov    0x80116654,%ecx
...
801022f4:	89 01                	mov    %eax,(%ecx)
  ioapic->data = data;
801022f6:	a1 54 66 11 80       	mov    0x80116654,%eax
  ioapicwrite(REG_TABLE+2*irq+1, cpunum << 24);
...
80102322:	81 fb c8 97 11 80    	cmp    $0x801197c8,%ebx
...
80102342:	e8 19 22 00 00       	call   80104560 <memset>
  ...
  if(kmem.use_lock)
80102347:	8b 15 94 66 11 80    	mov    0x80116694,%edx
...
80102354:	a1 98 66 11 80       	mov    0x80116698,%eax
80102359:	89 03                	mov    %eax,(%ebx)
  kmem.freelist = r;
  if(kmem.use_lock)
8010235b:	a1 94 66 11 80       	mov    0x80116694,%eax
  kmem.freelist = r;
80102360:	89 1d 98 66 11 80    	mov    %ebx,0x80116698
  if(kmem.use_lock)
...
8010236f:	90                   	nop
    release(&kmem.lock);
80102370:	c7 45 08 60 66 11 80 	movl   $0x80116660,0x8(%ebp)
}
...
80102383:	68 60 66 11 80       	push   $0x80116660
...
80102400:	68 60 66 11 80       	push   $0x80116660
...
8010240d:	83 c4 10             	add    $0x10,%esp
  kmem.use_lock = 0;
80102410:	c7 05 94 66 11 80 00 	movl   $0x0,0x80116694
80102417:	00 00 00 
  p = (char*)PGROUNDUP((uint)vstart);
...
801024a2:	73 e4                	jae    80102488 <kinit2+0x28>
  kmem.use_lock = 1;
801024a4:	c7 05 94 66 11 80 01 	movl   $0x1,0x80116694
801024ab:	00 00 00 
}
...
kalloc(void)
{
  ...
  if(kmem.use_lock)
801024c0:	a1 94 66 11 80       	mov    0x80116694,%eax
801024c5:	85 c0                	test   %eax,%eax
801024c7:	75 1f                	jne    801024e8 <kalloc+0x28>
    acquire(&kmem.lock);
  r = kmem.freelist;
801024c9:	a1 98 66 11 80       	mov    0x80116698,%eax
  if(r)
801024ce:	85 c0                	test   %eax,%eax
801024d0:	74 0e                	je     801024e0 <kalloc+0x20>
    kmem.freelist = r->next;
801024d2:	8b 10                	mov    (%eax),%edx
801024d4:	89 15 98 66 11 80    	mov    %edx,0x80116698
801024da:	c3                   	ret    
801024db:	90                   	nop
...
801024eb:	83 ec 24             	sub    $0x24,%esp
    acquire(&kmem.lock);
801024ee:	68 60 66 11 80       	push   $0x80116660
801024f3:	e8 58 1f 00 00       	call   80104450 <acquire>
  r = kmem.freelist;
801024f8:	a1 98 66 11 80       	mov    0x80116698,%eax
  if(r)
801024fd:	83 c4 10             	add    $0x10,%esp
80102500:	8b 15 94 66 11 80    	mov    0x80116694,%edx
80102506:	85 c0                	test   %eax,%eax
80102508:	74 08                	je     80102512 <kalloc+0x52>
    kmem.freelist = r->next;
8010250a:	8b 08                	mov    (%eax),%ecx
8010250c:	89 0d 98 66 11 80    	mov    %ecx,0x80116698
  if(kmem.use_lock)
...
8010251c:	68 60 66 11 80       	push   $0x80116660
...
{
  if(!lapic)
80102630:	a1 9c 66 11 80       	mov    0x8011669c,%eax
{
...
{
  if (!lapic)
80102730:	8b 15 9c 66 11 80    	mov    0x8011669c,%edx
{
...
{
  if(lapic)
80102750:	a1 9c 66 11 80       	mov    0x8011669c,%eax
{
...
801027b8:	66 a3 69 04 00 80    	mov    %ax,0x80000469
  lapic[index] = value;
801027be:	a1 9c 66 11 80       	mov    0x8011669c,%eax
...
80102a00:	8b 0d e8 66 11 80    	mov    0x801166e8,%ecx
...
80102a20:	a1 d4 66 11 80       	mov    0x801166d4,%eax
80102a25:	83 ec 08             	sub    $0x8,%esp
80102a28:	01 d8                	add    %ebx,%eax
80102a2a:	83 c0 01             	add    $0x1,%eax
80102a2d:	50                   	push   %eax
80102a2e:	ff 35 e4 66 11 80    	pushl  0x801166e4
80102a34:	e8 97 d6 ff ff       	call   801000d0 <bread>
80102a39:	89 c7                	mov    %eax,%edi
    struct buf *dbuf = bread(log.dev, log.lh.block[tail]); // read dst
80102a3b:	58                   	pop    %eax
80102a3c:	5a                   	pop    %edx
80102a3d:	ff 34 9d ec 66 11 80 	pushl  -0x7fee9914(,%ebx,4)
80102a44:	ff 35 e4 66 11 80    	pushl  0x801166e4
  for (tail = 0; tail < log.lh.n; tail++) {
...
80102a84:	39 1d e8 66 11 80    	cmp    %ebx,0x801166e8
...
80102aa8:	ff 35 d4 66 11 80    	pushl  0x801166d4
80102aae:	ff 35 e4 66 11 80    	pushl  0x801166e4
80102ab4:	e8 17 d6 ff ff       	call   801000d0 <bread>
  struct logheader *hb = (struct logheader *) (buf->data);
  int i;
  hb->n = log.lh.n;
80102ab9:	8b 1d e8 66 11 80    	mov    0x801166e8,%ebx
...
80102ad0:	8b 8a ec 66 11 80    	mov    -0x7fee9914(%edx),%ecx
...
80102b0f:	68 a0 66 11 80       	push   $0x801166a0
...
80102b2b:	59                   	pop    %ecx
  log.dev = dev;
80102b2c:	89 1d e4 66 11 80    	mov    %ebx,0x801166e4
  log.size = sb.nlog;
80102b32:	89 15 d8 66 11 80    	mov    %edx,0x801166d8
  log.start = sb.logstart;
80102b38:	a3 d4 66 11 80       	mov    %eax,0x801166d4
  struct buf *buf = bread(log.dev, log.start);
80102b3d:	5a                   	pop    %edx
...
80102b4b:	85 db                	test   %ebx,%ebx
  log.lh.n = lh->n;
80102b4d:	89 1d e8 66 11 80    	mov    %ebx,0x801166e8
  for (i = 0; i < log.lh.n; i++) {
...
80102b67:	89 8a e8 66 11 80    	mov    %ecx,-0x7fee9918(%edx)
  for (i = 0; i < log.lh.n; i++) {
...
80102b7a:	e8 81 fe ff ff       	call   80102a00 <install_trans>
  log.lh.n = 0;
80102b7f:	c7 05 e8 66 11 80 00 	movl   $0x0,0x801166e8
80102b86:	00 00 00 
...
80102ba3:	83 ec 14             	sub    $0x14,%esp
  acquire(&log.lock);
80102ba6:	68 a0 66 11 80       	push   $0x801166a0
...
80102bbb:	68 a0 66 11 80       	push   $0x801166a0
80102bc0:	68 a0 66 11 80       	push   $0x801166a0
80102bc5:	e8 a6 12 00 00       	call   80103e70 <sleep>
80102bca:	83 c4 10             	add    $0x10,%esp
    if(log.committing){
80102bcd:	a1 e0 66 11 80       	mov    0x801166e0,%eax
80102bd2:	85 c0                	test   %eax,%eax
80102bd4:	75 e2                	jne    80102bb8 <begin_op+0x18>
    } else if(log.lh.n + (log.outstanding+1)*MAXOPBLOCKS > LOGSIZE){
80102bd6:	a1 dc 66 11 80       	mov    0x801166dc,%eax
80102bdb:	8b 15 e8 66 11 80    	mov    0x801166e8,%edx
...
80102bef:	83 ec 0c             	sub    $0xc,%esp
      log.outstanding += 1;
80102bf2:	a3 dc 66 11 80       	mov    %eax,0x801166dc
      release(&log.lock);
80102bf7:	68 a0 66 11 80       	push   $0x801166a0
...
80102c16:	83 ec 18             	sub    $0x18,%esp
  ...
  acquire(&log.lock);
80102c19:	68 a0 66 11 80       	push   $0x801166a0
80102c1e:	e8 2d 18 00 00       	call   80104450 <acquire>
  log.outstanding -= 1;
80102c23:	a1 dc 66 11 80       	mov    0x801166dc,%eax
  if(log.committing)
80102c28:	8b 35 e0 66 11 80    	mov    0x801166e0,%esi
...
80102c34:	85 f6                	test   %esi,%esi
  log.outstanding -= 1;
80102c36:	89 1d dc 66 11 80    	mov    %ebx,0x801166dc
  if(log.committing)
...
80102c4a:	83 ec 0c             	sub    $0xc,%esp
    log.committing = 1;
80102c4d:	c7 05 e0 66 11 80 01 	movl   $0x1,0x801166e0
80102c54:	00 00 00 
  release(&log.lock);
80102c57:	68 a0 66 11 80       	push   $0x801166a0
...
{
  if (log.lh.n > 0) {
80102c61:	8b 0d e8 66 11 80    	mov    0x801166e8,%ecx
80102c67:	83 c4 10             	add    $0x10,%esp
80102c6a:	85 c9                	test   %ecx,%ecx
80102c6c:	0f 8e 85 00 00 00    	jle    80102cf7 <end_op+0xe7>
    struct buf *to = bread(log.dev, log.start+tail+1); // log block
80102c72:	a1 d4 66 11 80       	mov    0x801166d4,%eax
80102c77:	83 ec 08             	sub    $0x8,%esp
80102c7a:	01 d8                	add    %ebx,%eax
80102c7c:	83 c0 01             	add    $0x1,%eax
80102c7f:	50                   	push   %eax
80102c80:	ff 35 e4 66 11 80    	pushl  0x801166e4
80102c86:	e8 45 d4 ff ff       	call   801000d0 <bread>
80102c8b:	89 c6                	mov    %eax,%esi
    struct buf *from = bread(log.dev, log.lh.block[tail]); // cache block
80102c8d:	58                   	pop    %eax
80102c8e:	5a                   	pop    %edx
80102c8f:	ff 34 9d ec 66 11 80 	pushl  -0x7fee9914(,%ebx,4)
80102c96:	ff 35 e4 66 11 80    	pushl  0x801166e4
  for (tail = 0; tail < log.lh.n; tail++) {
...
80102cd6:	3b 1d e8 66 11 80    	cmp    0x801166e8,%ebx
...
80102ce3:	e8 18 fd ff ff       	call   80102a00 <install_trans>
    log.lh.n = 0;
80102ce8:	c7 05 e8 66 11 80 00 	movl   $0x0,0x801166e8
80102cef:	00 00 00 
    write_head();    // Erase the transaction from the log
80102cf2:	e8 a9 fd ff ff       	call   80102aa0 <write_head>
    acquire(&log.lock);
80102cf7:	83 ec 0c             	sub    $0xc,%esp
80102cfa:	68 a0 66 11 80       	push   $0x801166a0
80102cff:	e8 4c 17 00 00       	call   80104450 <acquire>
    wakeup(&log);
80102d04:	c7 04 24 a0 66 11 80 	movl   $0x801166a0,(%esp)
    log.committing = 0;
80102d0b:	c7 05 e0 66 11 80 00 	movl   $0x0,0x801166e0
80102d12:	00 00 00 
    wakeup(&log);
80102d15:	e8 16 13 00 00       	call   80104030 <wakeup>
    release(&log.lock);
80102d1a:	c7 04 24 a0 66 11 80 	movl   $0x801166a0,(%esp)
...
80102d3b:	68 a0 66 11 80       	push   $0x801166a0
80102d40:	e8 eb 12 00 00       	call   80104030 <wakeup>
  release(&log.lock);
80102d45:	c7 04 24 a0 66 11 80 	movl   $0x801166a0,(%esp)
...
80102d77:	8b 15 e8 66 11 80    	mov    0x801166e8,%edx
{
80102d7d:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if (log.lh.n >= LOGSIZE || log.lh.n >= log.size - 1)
80102d80:	83 fa 1d             	cmp    $0x1d,%edx
80102d83:	0f 8f 9d 00 00 00    	jg     80102e26 <log_write+0xb6>
80102d89:	a1 d8 66 11 80       	mov    0x801166d8,%eax
80102d8e:	83 e8 01             	sub    $0x1,%eax
80102d91:	39 c2                	cmp    %eax,%edx
80102d93:	0f 8d 8d 00 00 00    	jge    80102e26 <log_write+0xb6>
    panic("too big a transaction");
  if (log.outstanding < 1)
80102d99:	a1 dc 66 11 80       	mov    0x801166dc,%eax
...
80102da9:	68 a0 66 11 80       	push   $0x801166a0
80102dae:	e8 9d 16 00 00       	call   80104450 <acquire>
  for (i = 0; i < log.lh.n; i++) {
80102db3:	8b 0d e8 66 11 80    	mov    0x801166e8,%ecx
...
80102dc4:	31 c0                	xor    %eax,%eax
    if (log.lh.block[i] == b->blockno)   // log absorbtion
80102dc6:	3b 15 ec 66 11 80    	cmp    0x801166ec,%edx
80102dcc:	75 0b                	jne    80102dd9 <log_write+0x69>
80102dce:	eb 38                	jmp    80102e08 <log_write+0x98>
80102dd0:	39 14 85 ec 66 11 80 	cmp    %edx,-0x7fee9914(,%eax,4)
...
80102de0:	89 14 85 ec 66 11 80 	mov    %edx,-0x7fee9914(,%eax,4)
  if (i == log.lh.n)
    log.lh.n++;
80102de7:	83 c0 01             	add    $0x1,%eax
80102dea:	a3 e8 66 11 80       	mov    %eax,0x801166e8
  b->flags |= B_DIRTY; // prevent eviction
80102def:	83 0b 04             	orl    $0x4,(%ebx)
  release(&log.lock);
80102df2:	c7 45 08 a0 66 11 80 	movl   $0x801166a0,0x8(%ebp)
}
...
80102e02:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  log.lh.block[i] = b->blockno;
80102e08:	89 14 85 ec 66 11 80 	mov    %edx,-0x7fee9914(,%eax,4)
80102e0f:	eb de                	jmp    80102def <log_write+0x7f>
80102e11:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80102e18:	8b 43 08             	mov    0x8(%ebx),%eax
80102e1b:	a3 ec 66 11 80       	mov    %eax,0x801166ec
  if (i == log.lh.n)
...
80102eaa:	55                   	push   %ebp
  readcnt = 0;
80102eab:	c7 05 74 8f 11 80 00 	movl   $0x0,0x80118f74
80102eb2:	00 00 00 
{
...
80102eb9:	83 ec 08             	sub    $0x8,%esp
80102ebc:	68 00 00 40 80       	push   $0x80400000
80102ec1:	68 c8 97 11 80       	push   $0x801197c8
80102ec6:	e8 25 f5 ff ff       	call   801023f0 <kinit1>
  kvmalloc();      // kernel page table
80102ecb:	e8 e0 3e 00 00       	call   80106db0 <kvmalloc>
  mpinit();        // detect other processors
80102ed0:	e8 7b 01 00 00       	call   80103050 <mpinit>
  lapicinit();     // interrupt controller
80102ed5:	e8 56 f7 ff ff       	call   80102630 <lapicinit>
  seginit();       // segment descriptors
80102eda:	e8 71 39 00 00       	call   80106850 <seginit>
  picinit();       // disable pic
80102edf:	e8 4c 03 00 00       	call   80103230 <picinit>
  ioapicinit();    // another interrupt controller
80102ee4:	e8 37 f3 ff ff       	call   80102220 <ioapicinit>
  consoleinit();   // console hardware
80102ee9:	e8 d2 da ff ff       	call   801009c0 <consoleinit>
  uartinit();      // serial port
80102eee:	e8 2d 2c 00 00       	call   80105b20 <uartinit>
  pinit();         // process table
80102ef3:	e8 38 08 00 00       	call   80103730 <pinit>
  tvinit();        // trap vectors
80102ef8:	e8 73 28 00 00       	call   80105770 <tvinit>
  binit();         // buffer cache
80102efd:	e8 3e d1 ff ff       	call   80100040 <binit>
  fileinit();      // file table
80102f02:	e8 59 de ff ff       	call   80100d60 <fileinit>
  ideinit();       // disk 
80102f07:	e8 f4 f0 ff ff       	call   80102000 <ideinit>
...
80102f1e:	e8 ed 16 00 00       	call   80104610 <memmove>

  for(c = cpus; c < cpus+ncpu; c++){
80102f23:	69 05 20 6d 11 80 b0 	imul   $0xb0,0x80116d20,%eax
80102f2a:	00 00 00 
80102f2d:	83 c4 10             	add    $0x10,%esp
80102f30:	05 a0 67 11 80       	add    $0x801167a0,%eax
80102f35:	3d a0 67 11 80       	cmp    $0x801167a0,%eax
80102f3a:	76 77                	jbe    80102fb3 <main+0x113>
80102f3c:	bb a0 67 11 80       	mov    $0x801167a0,%ebx
80102f41:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    if(c == mycpu())  // We've started already.
80102f48:	e8 c3 08 00 00       	call   80103810 <mycpu>
80102f4d:	39 d8                	cmp    %ebx,%eax
80102f4f:	74 49                	je     80102f9a <main+0xfa>
      continue;
    ...
    stack = kalloc();
80102f51:	e8 6a f5 ff ff       	call   801024c0 <kalloc>
    *(void**)(code-4) = stack + KSTACKSIZE;
80102f56:	05 00 10 00 00       	add    $0x1000,%eax
    *(void(**)(void))(code-8) = mpenter;
80102f5b:	c7 05 f8 6f 00 80 80 	movl   $0x80102e80,0x80006ff8
80102f62:	2e 10 80 
    *(int**)(code-12) = (void *) V2P(entrypgdir);
80102f65:	c7 05 f4 6f 00 80 00 	movl   $0x109000,0x80006ff4
80102f6c:	90 10 00 
    *(void**)(code-4) = stack + KSTACKSIZE;
...
80102f80:	e8 fb f7 ff ff       	call   80102780 <lapicstartap>
...
80102f98:	74 f6                	je     80102f90 <main+0xf0>
  for(c = cpus; c < cpus+ncpu; c++){
80102f9a:	69 05 20 6d 11 80 b0 	imul   $0xb0,0x80116d20,%eax
80102fa1:	00 00 00 
80102fa4:	81 c3 b0 00 00 00    	add    $0xb0,%ebx
80102faa:	05 a0 67 11 80       	add    $0x801167a0,%eax
80102faf:	39 c3                	cmp    %eax,%ebx
80102fb1:	72 95                	jb     80102f48 <main+0xa8>
  kinit2(P2V(4*1024*1024), P2V(PHYSTOP)); // must come after startothers()
80102fb3:	83 ec 08             	sub    $0x8,%esp
80102fb6:	68 00 00 00 8e       	push   $0x8e000000
80102fbb:	68 00 00 40 80       	push   $0x80400000
80102fc0:	e8 9b f4 ff ff       	call   80102460 <kinit2>
  userinit();      // first user process
80102fc5:	e8 16 09 00 00       	call   801038e0 <userinit>
  mpmain();        // finish this processor's setup
80102fca:	e8 71 fe ff ff       	call   80102e40 <mpmain>
80102fcf:	90                   	nop
...
80103127:	a3 9c 66 11 80       	mov    %eax,0x8011669c
...
80103195:	8d 76 00             	lea    0x0(%esi),%esi
      if(ncpu < NCPU) {
80103198:	8b 0d 20 6d 11 80    	mov    0x80116d20,%ecx
...
801031b0:	89 0d 20 6d 11 80    	mov    %ecx,0x80116d20
        cpus[ncpu].apicid = proc->apicid;  // apicid may differ from ncpu
801031b6:	88 97 a0 67 11 80    	mov    %dl,-0x7fee9860(%edi)
...
801031cc:	83 c0 08             	add    $0x8,%eax
      ioapicid = ioapic->apicno;
801031cf:	88 15 80 67 11 80    	mov    %dl,0x80116780
      continue;
...
80103281:	e8 3a f2 ff ff       	call   801024c0 <kalloc>
...
801033f4:	5d                   	pop    %ebp
    kfree((char*)p);
801033f5:	e9 16 ef ff ff       	jmp    80102310 <kfree>
...
80103494:	e8 17 04 00 00       	call   801038b0 <myproc>
...
80103573:	0f 84 8f 00 00 00    	je     80103608 <piperead+0xf8>
    if(myproc()->killed){
80103579:	e8 32 03 00 00       	call   801038b0 <myproc>
...
80103614:	bb 74 6d 11 80       	mov    $0x80116d74,%ebx
{
80103619:	83 ec 10             	sub    $0x10,%esp
  acquire(&ptable.lock);
8010361c:	68 40 6d 11 80       	push   $0x80116d40
...
80103636:	81 fb 74 8f 11 80    	cmp    $0x80118f74,%ebx
...
found:
  p->state = EMBRYO;
  p->pid = nextpid++;
80103645:	a1 0c a0 10 80       	mov    0x8010a00c,%eax
...
80103657:	89 43 10             	mov    %eax,0x10(%ebx)
  release(&ptable.lock);
8010365a:	68 40 6d 11 80       	push   $0x80116d40
  p->pid = nextpid++;
8010365f:	89 15 0c a0 10 80    	mov    %edx,0x8010a00c
  release(&ptable.lock);
80103665:	e8 a6 0e 00 00       	call   80104510 <release>

  // Allocate kernel stack.
  if((p->kstack = kalloc()) == 0){
8010366a:	e8 51 ee ff ff       	call   801024c0 <kalloc>
...
80103687:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
8010368a:	c7 40 14 62 57 10 80 	movl   $0x80105762,0x14(%eax)
  p->context = (struct context*)sp;
...
80103699:	e8 c2 0e 00 00       	call   80104560 <memset>
...
801036bb:	31 db                	xor    %ebx,%ebx
  release(&ptable.lock);
801036bd:	68 40 6d 11 80       	push   $0x80116d40
801036c2:	e8 49 0e 00 00       	call   80104510 <release>
}
...
801036e3:	83 ec 14             	sub    $0x14,%esp
  ...
  release(&ptable.lock);
801036e6:	68 40 6d 11 80       	push   $0x80116d40
...
8010373b:	68 40 6d 11 80       	push   $0x80116d40
...
80103754:	8b 4d 08             	mov    0x8(%ebp),%ecx
  Q[2] = x + PHI + PHI;
80103757:	8d 81 72 f3 6e 3c    	lea    0x3c6ef372(%ecx),%eax
  Q[1] = x + PHI;
8010375d:	8d 99 b9 79 37 9e    	lea    -0x61c88647(%ecx),%ebx
  Q[0] = x;
80103763:	89 0d c0 a5 10 80    	mov    %ecx,0x8010a5c0
  Q[2] = x + PHI + PHI;
80103769:	a3 c8 a5 10 80       	mov    %eax,0x8010a5c8
  Q[1] = x + PHI;
8010376e:	89 1d c4 a5 10 80    	mov    %ebx,0x8010a5c4
  for (i = 3; i < 4096; i++)
80103774:	b8 03 00 00 00       	mov    $0x3,%eax
80103779:	eb 13                	jmp    8010378e <srand+0x3e>
8010377b:	90                   	nop
8010377c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103780:	8b 0c 85 b4 a5 10 80 	mov    -0x7fef5a4c(,%eax,4),%ecx
80103787:	8b 1c 85 b8 a5 10 80 	mov    -0x7fef5a48(,%eax,4),%ebx
    Q[i] = Q[i - 3] ^ Q[i - 2] ^ PHI ^ i;
8010378e:	89 c2                	mov    %eax,%edx
80103790:	81 f2 b9 79 37 9e    	xor    $0x9e3779b9,%edx
80103796:	31 ca                	xor    %ecx,%edx
80103798:	31 da                	xor    %ebx,%edx
8010379a:	89 14 85 c0 a5 10 80 	mov    %edx,-0x7fef5a40(,%eax,4)
  for (i = 3; i < 4096; i++)
801037a1:	83 c0 01             	add    $0x1,%eax
801037a4:	3d 00 10 00 00       	cmp    $0x1000,%eax
801037a9:	75 d5                	jne    80103780 <srand+0x30>
}
801037ab:	5b                   	pop    %ebx
801037ac:	5d                   	pop    %ebp
801037ad:	c3                   	ret    
...
801037b0 <rand>:
  i = (i + 1) & 4095;
801037b0:	a1 04 a0 10 80       	mov    0x8010a004,%eax
{
801037b5:	55                   	push   %ebp
  t = a * Q[i] + c;
801037b6:	b9 5e 49 00 00       	mov    $0x495e,%ecx
{
...
801037bf:	53                   	push   %ebx
  i = (i + 1) & 4095;
801037c0:	8d 58 01             	lea    0x1(%eax),%ebx
  t = a * Q[i] + c;
801037c3:	89 c8                	mov    %ecx,%eax
801037c5:	8b 35 08 a0 10 80    	mov    0x8010a008,%esi
801037cb:	31 ff                	xor    %edi,%edi
  i = (i + 1) & 4095;
801037cd:	81 e3 ff 0f 00 00    	and    $0xfff,%ebx
  t = a * Q[i] + c;
801037d3:	f7 24 9d c0 a5 10 80 	mull   -0x7fef5a40(,%ebx,4)
  i = (i + 1) & 4095;
801037da:	89 1d 04 a0 10 80    	mov    %ebx,0x8010a004
  t = a * Q[i] + c;
801037e0:	01 c6                	add    %eax,%esi
801037e2:	11 d7                	adc    %edx,%edi
801037e4:	89 f2                	mov    %esi,%edx
801037e6:	01 fa                	add    %edi,%edx
  c = (t >> 32);
801037e8:	89 f8                	mov    %edi,%eax
  if (x < c) {
801037ea:	73 06                	jae    801037f2 <rand+0x42>
    x++;
801037ec:	83 c2 01             	add    $0x1,%edx
    c++;
801037ef:	83 c0 01             	add    $0x1,%eax
801037f2:	a3 08 a0 10 80       	mov    %eax,0x8010a008
  return (Q[i] = r - x);
801037f7:	b8 fe ff ff ff       	mov    $0xfffffffe,%eax
801037fc:	29 d0                	sub    %edx,%eax
801037fe:	89 04 9d c0 a5 10 80 	mov    %eax,-0x7fef5a40(,%ebx,4)
}
80103805:	5b                   	pop    %ebx
80103806:	5e                   	pop    %esi
80103807:	5f                   	pop    %edi
...
8010381c:	e8 0f ef ff ff       	call   80102730 <lapicid>
  for (i = 0; i < ncpu; ++i) {
80103821:	8b 35 20 6d 11 80    	mov    0x80116d20,%esi
80103827:	85 f6                	test   %esi,%esi
80103829:	7e 42                	jle    8010386d <mycpu+0x5d>
    if (cpus[i].apicid == apicid)
8010382b:	0f b6 15 a0 67 11 80 	movzbl 0x801167a0,%edx
80103832:	39 d0                	cmp    %edx,%eax
80103834:	74 30                	je     80103866 <mycpu+0x56>
80103836:	b9 50 68 11 80       	mov    $0x80116850,%ecx
  for (i = 0; i < ncpu; ++i) {
...
8010385a:	05 a0 67 11 80       	add    $0x801167a0,%eax
}
...
8010389b:	2d a0 67 11 80       	sub    $0x801167a0,%eax
}
801038a0:	c9                   	leave  
  return mycpu()-cpus;
...
801038b4:	83 ec 04             	sub    $0x4,%esp
  pushcli();
801038b7:	e8 c4 0a 00 00       	call   80104380 <pushcli>
  c = mycpu();
801038bc:	e8 4f ff ff ff       	call   80103810 <mycpu>
  p = c->proc;
801038c1:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801038c7:	e8 f4 0a 00 00       	call   801043c0 <popcli>
}
...
801038e4:	83 ec 04             	sub    $0x4,%esp
  p = allocproc();
801038e7:	e8 24 fd ff ff       	call   80103610 <allocproc>
801038ec:	89 c3                	mov    %eax,%ebx
  initproc = p;
801038ee:	a3 c0 e5 10 80       	mov    %eax,0x8010e5c0
  if((p->pgdir = setupkvm()) == 0)
801038f3:	e8 38 34 00 00       	call   80106d30 <setupkvm>
...
80103911:	e8 fa 30 00 00       	call   80106a10 <inituvm>
...
80103926:	e8 35 0c 00 00       	call   80104560 <memset>
...
8010397f:	68 65 75 10 80       	push   $0x80107565
80103984:	50                   	push   %eax
80103985:	e8 b6 0d 00 00       	call   80104740 <safestrcpy>
  p->cwd = namei("/");
8010398a:	c7 04 24 6e 75 10 80 	movl   $0x8010756e,(%esp)
80103991:	e8 4a e5 ff ff       	call   80101ee0 <namei>
80103996:	89 43 68             	mov    %eax,0x68(%ebx)
  acquire(&ptable.lock);
80103999:	c7 04 24 40 6d 11 80 	movl   $0x80116d40,(%esp)
801039a0:	e8 ab 0a 00 00       	call   80104450 <acquire>
  p->state = RUNNABLE;
801039a5:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  release(&ptable.lock);
801039ac:	c7 04 24 40 6d 11 80 	movl   $0x80116d40,(%esp)
801039b3:	e8 58 0b 00 00       	call   80104510 <release>
}
...
801039c3:	68 4c 75 10 80       	push   $0x8010754c
...
801039d5:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
801039d8:	e8 a3 09 00 00       	call   80104380 <pushcli>
  c = mycpu();
801039dd:	e8 2e fe ff ff       	call   80103810 <mycpu>
  p = c->proc;
801039e2:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801039e8:	e8 d3 09 00 00       	call   801043c0 <popcli>
  if(n > 0){
...
801039fc:	e8 ff 2e 00 00       	call   80106900 <switchuvm>
  return 0;
...
80103a1a:	e8 31 31 00 00       	call   80106b50 <allocuvm>
...
80103a3a:	e8 41 32 00 00       	call   80106c80 <deallocuvm>
...
80103a56:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80103a59:	e8 22 09 00 00       	call   80104380 <pushcli>
  c = mycpu();
80103a5e:	e8 ad fd ff ff       	call   80103810 <mycpu>
  p = c->proc;
80103a63:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103a69:	e8 52 09 00 00       	call   801043c0 <popcli>
  if((np = allocproc()) == 0){
...
80103a88:	e8 73 33 00 00       	call   80106e00 <copyuvm>
...
80103b01:	e8 3a 0c 00 00       	call   80104740 <safestrcpy>
  pid = np->pid;
80103b06:	8b 5f 10             	mov    0x10(%edi),%ebx
  acquire(&ptable.lock);
80103b09:	c7 04 24 40 6d 11 80 	movl   $0x80116d40,(%esp)
80103b10:	e8 3b 09 00 00       	call   80104450 <acquire>
  np->state = RUNNABLE;
80103b15:	c7 47 0c 03 00 00 00 	movl   $0x3,0xc(%edi)
  release(&ptable.lock);
80103b1c:	c7 04 24 40 6d 11 80 	movl   $0x80116d40,(%esp)
80103b23:	e8 e8 09 00 00       	call   80104510 <release>
  return pid;
...
80103b85:	00 00 00 
  struct cpu *c = mycpu();
80103b88:	89 c3                	mov    %eax,%ebx
80103b8a:	8d 40 04             	lea    0x4(%eax),%eax
80103b8d:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  asm volatile("sti");
80103b90:	fb                   	sti    
    acquire(&ptable.lock);
80103b91:	83 ec 0c             	sub    $0xc,%esp
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103b94:	bf 74 6d 11 80       	mov    $0x80116d74,%edi
    acquire(&ptable.lock);
80103b99:	68 40 6d 11 80       	push   $0x80116d40
80103b9e:	e8 ad 08 00 00       	call   80104450 <acquire>
80103ba3:	83 c4 10             	add    $0x10,%esp
80103ba6:	8d 76 00             	lea    0x0(%esi),%esi
80103ba9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
      if(p->state != RUNNABLE)
80103bb0:	83 7f 0c 03          	cmpl   $0x3,0xc(%edi)
80103bb4:	75 49                	jne    80103bff <scheduler+0x8f>
      switchuvm(p);
80103bb6:	83 ec 0c             	sub    $0xc,%esp
      c->proc = p;
80103bb9:	89 bb ac 00 00 00    	mov    %edi,0xac(%ebx)
      switchuvm(p);
80103bbf:	57                   	push   %edi
80103bc0:	e8 3b 2d 00 00       	call   80106900 <switchuvm>
      swtch(&(c->scheduler), p->context);
80103bc5:	58                   	pop    %eax
80103bc6:	5a                   	pop    %edx
80103bc7:	ff 77 1c             	pushl  0x1c(%edi)
80103bca:	ff 75 e4             	pushl  -0x1c(%ebp)
      const int tickstarts = ticks;
80103bcd:	8b 35 c0 97 11 80    	mov    0x801197c0,%esi
      p->state = RUNNING;
80103bd3:	c7 47 0c 04 00 00 00 	movl   $0x4,0xc(%edi)
      swtch(&(c->scheduler), p->context);
80103bda:	e8 bc 0b 00 00       	call   8010479b <swtch>
      switchkvm();
80103bdf:	e8 fc 2c 00 00       	call   801068e0 <switchkvm>
      p->ticks += ticks - tickstarts;
80103be4:	8b 15 c0 97 11 80    	mov    0x801197c0,%edx
      c->proc = 0;
80103bea:	83 c4 10             	add    $0x10,%esp
      p->ticks += ticks - tickstarts;
80103bed:	29 f2                	sub    %esi,%edx
80103bef:	01 97 80 00 00 00    	add    %edx,0x80(%edi)
      c->proc = 0;
80103bf5:	c7 83 ac 00 00 00 00 	movl   $0x0,0xac(%ebx)
80103bfc:	00 00 00 
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103bff:	81 c7 88 00 00 00    	add    $0x88,%edi
80103c05:	81 ff 74 8f 11 80    	cmp    $0x80118f74,%edi
80103c0b:	72 a3                	jb     80103bb0 <scheduler+0x40>
    release(&ptable.lock);
80103c0d:	83 ec 0c             	sub    $0xc,%esp
80103c10:	68 40 6d 11 80       	push   $0x80116d40
80103c15:	e8 f6 08 00 00       	call   80104510 <release>
    sti();
80103c1a:	83 c4 10             	add    $0x10,%esp
80103c1d:	e9 6e ff ff ff       	jmp    80103b90 <scheduler+0x20>
...
80103c34:	53                   	push   %ebx
  pushcli();
80103c35:	e8 46 07 00 00       	call   80104380 <pushcli>
  c = mycpu();
80103c3a:	e8 d1 fb ff ff       	call   80103810 <mycpu>
  p = c->proc;
80103c3f:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103c45:	e8 76 07 00 00       	call   801043c0 <popcli>
  if(!holding(&ptable.lock))
80103c4a:	83 ec 0c             	sub    $0xc,%esp
80103c4d:	68 40 6d 11 80       	push   $0x80116d40
80103c52:	e8 c9 07 00 00       	call   80104420 <holding>
80103c57:	83 c4 10             	add    $0x10,%esp
80103c5a:	85 c0                	test   %eax,%eax
80103c5c:	74 4f                	je     80103cad <sched+0x7d>
  if(mycpu()->ncli != 1)
80103c5e:	e8 ad fb ff ff       	call   80103810 <mycpu>
...
80103c77:	75 41                	jne    80103cba <sched+0x8a>
  intena = mycpu()->intena;
80103c79:	e8 92 fb ff ff       	call   80103810 <mycpu>
  swtch(&p->context, mycpu()->scheduler);
80103c7e:	83 c3 1c             	add    $0x1c,%ebx
  intena = mycpu()->intena;
80103c81:	8b b0 a8 00 00 00    	mov    0xa8(%eax),%esi
  swtch(&p->context, mycpu()->scheduler);
80103c87:	e8 84 fb ff ff       	call   80103810 <mycpu>
80103c8c:	83 ec 08             	sub    $0x8,%esp
80103c8f:	ff 70 04             	pushl  0x4(%eax)
80103c92:	53                   	push   %ebx
80103c93:	e8 03 0b 00 00       	call   8010479b <swtch>
  mycpu()->intena = intena;
80103c98:	e8 73 fb ff ff       	call   80103810 <mycpu>
}
...
80103cf6:	83 ec 0c             	sub    $0xc,%esp
  pushcli();
80103cf9:	e8 82 06 00 00       	call   80104380 <pushcli>
  c = mycpu();
80103cfe:	e8 0d fb ff ff       	call   80103810 <mycpu>
  p = c->proc;
80103d03:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103d09:	e8 b2 06 00 00       	call   801043c0 <popcli>
  if(curproc == initproc)
80103d0e:	39 35 c0 e5 10 80    	cmp    %esi,0x8010e5c0
...
80103d3d:	75 e1                	jne    80103d20 <exit+0x30>
  begin_op();
80103d3f:	e8 5c ee ff ff       	call   80102ba0 <begin_op>
  iput(curproc->cwd);
80103d44:	83 ec 0c             	sub    $0xc,%esp
80103d47:	ff 76 68             	pushl  0x68(%esi)
80103d4a:	e8 61 da ff ff       	call   801017b0 <iput>
  end_op();
80103d4f:	e8 bc ee ff ff       	call   80102c10 <end_op>
  curproc->cwd = 0;
80103d54:	c7 46 68 00 00 00 00 	movl   $0x0,0x68(%esi)
  acquire(&ptable.lock);
80103d5b:	c7 04 24 40 6d 11 80 	movl   $0x80116d40,(%esp)
...
80103d9b:	3d 74 8f 11 80       	cmp    $0x80118f74,%eax
80103da0:	72 e2                	jb     80103d84 <exit+0x94>
      p->parent = initproc;
80103da2:	8b 0d c0 e5 10 80    	mov    0x8010e5c0,%ecx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103da8:	ba 74 6d 11 80       	mov    $0x80116d74,%edx
80103dad:	eb 0f                	jmp    80103dbe <exit+0xce>
80103daf:	90                   	nop
80103db0:	81 c2 88 00 00 00    	add    $0x88,%edx
80103db6:	81 fa 74 8f 11 80    	cmp    $0x80118f74,%edx
...
80103e7c:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
80103e7f:	e8 fc 04 00 00       	call   80104380 <pushcli>
  c = mycpu();
80103e84:	e8 87 f9 ff ff       	call   80103810 <mycpu>
  p = c->proc;
80103e89:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103e8f:	e8 2c 05 00 00       	call   801043c0 <popcli>
  if(p == 0)
...
80103ea0:	81 fe 40 6d 11 80    	cmp    $0x80116d40,%esi
80103ea6:	74 50                	je     80103ef8 <sleep+0x88>
    acquire(&ptable.lock);  //DOC: sleeplock1
80103ea8:	83 ec 0c             	sub    $0xc,%esp
80103eab:	68 40 6d 11 80       	push   $0x80116d40
...
80103ecc:	c7 43 20 00 00 00 00 	movl   $0x0,0x20(%ebx)
    release(&ptable.lock);
80103ed3:	c7 04 24 40 6d 11 80 	movl   $0x80116d40,(%esp)
...
80103f87:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103f8c:	81 fb 74 8f 11 80    	cmp    $0x80118f74,%ebx
...
80103fa2:	68 40 6d 11 80       	push   $0x80116d40
...
80103fca:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80103fd1:	e8 da 2c 00 00       	call   80106cb0 <freevm>
        release(&ptable.lock);
80103fd6:	c7 04 24 40 6d 11 80 	movl   $0x80116d40,(%esp)
        p->pid = 0;
...
80103ff6:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
80103ffd:	e8 0e 05 00 00       	call   80104510 <release>
        return pid;
...
80104011:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
80104016:	68 40 6d 11 80       	push   $0x80116d40
8010401b:	e8 f0 04 00 00       	call   80104510 <release>
      return -1;
...
80104037:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&ptable.lock);
8010403a:	68 40 6d 11 80       	push   $0x80116d40
8010403f:	e8 0c 04 00 00       	call   80104450 <acquire>
80104044:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104047:	b8 74 6d 11 80       	mov    $0x80116d74,%eax
8010404c:	eb 0e                	jmp    8010405c <wakeup+0x2c>
8010404e:	66 90                	xchg   %ax,%ax
80104050:	05 88 00 00 00       	add    $0x88,%eax
80104055:	3d 74 8f 11 80       	cmp    $0x80118f74,%eax
...
80104073:	3d 74 8f 11 80       	cmp    $0x80118f74,%eax
80104078:	72 e2                	jb     8010405c <wakeup+0x2c>
  wakeup1(chan);
  release(&ptable.lock);
8010407a:	c7 45 08 40 6d 11 80 	movl   $0x80116d40,0x8(%ebp)
}
80104081:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80104084:	c9                   	leave  
  release(&ptable.lock);
80104085:	e9 86 04 00 00       	jmp    80104510 <release>
...
80104097:	8b 5d 08             	mov    0x8(%ebp),%ebx
  ...
  acquire(&ptable.lock);
8010409a:	68 40 6d 11 80       	push   $0x80116d40
8010409f:	e8 ac 03 00 00       	call   80104450 <acquire>
801040a4:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801040a7:	b8 74 6d 11 80       	mov    $0x80116d74,%eax
801040ac:	eb 0e                	jmp    801040bc <kill+0x2c>
801040ae:	66 90                	xchg   %ax,%ax
801040b0:	05 88 00 00 00       	add    $0x88,%eax
801040b5:	3d 74 8f 11 80       	cmp    $0x80118f74,%eax
...
801040d8:	68 40 6d 11 80       	push   $0x80116d40
801040dd:	e8 2e 04 00 00       	call   80104510 <release>
      return 0;
...
801040f3:	68 40 6d 11 80       	push   $0x80116d40
801040f8:	e8 13 04 00 00       	call   80104510 <release>
  return -1;
...
80104116:	8d 75 e8             	lea    -0x18(%ebp),%esi
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104119:	bb 74 6d 11 80       	mov    $0x80116d74,%ebx
{
...
8010415b:	8b 14 85 40 76 10 80 	mov    -0x7fef89c0(,%eax,4),%edx
      state = "???";
...
80104174:	68 e4 75 10 80       	push   $0x801075e4
...
8010419b:	e8 90 01 00 00       	call   80104330 <getcallerpcs>
...
801041b9:	68 21 70 10 80       	push   $0x80107021
...
801041ea:	68 58 76 10 80       	push   $0x80107658
...
80104253:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104259:	e8 52 f6 ff ff       	call   801038b0 <myproc>
...
801042e3:	e8 c8 f5 ff ff       	call   801038b0 <myproc>
...
80104389:	fa                   	cli    
  ...
  cli();
  if(mycpu()->ncli == 0)
8010438a:	e8 81 f4 ff ff       	call   80103810 <mycpu>
...
8010439f:	e8 6c f4 ff ff       	call   80103810 <mycpu>
801043a4:	89 98 a8 00 00 00    	mov    %ebx,0xa8(%eax)
  mycpu()->ncli += 1;
801043aa:	e8 61 f4 ff ff       	call   80103810 <mycpu>
...
801043ec:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  if(mycpu()->ncli == 0 && mycpu()->intena)
801043f0:	e8 1b f4 ff ff       	call   80103810 <mycpu>
...
80104405:	68 63 76 10 80       	push   $0x80107663
8010440a:	e8 81 bf ff ff       	call   80100390 <panic>
    panic("popcli");
8010440f:	83 ec 0c             	sub    $0xc,%esp
80104412:	68 7a 76 10 80       	push   $0x8010767a
...
80104438:	e8 d3 f3 ff ff       	call   80103810 <mycpu>
...
80104494:	e8 77 f3 ff ff       	call   80103810 <mycpu>
...
801044f7:	68 81 76 10 80       	push   $0x80107681
...
8010454c:	68 89 76 10 80       	push   $0x80107689
...
801047f7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
801047fa:	e8 b1 f0 ff ff       	call   801038b0 <myproc>
...
80104865:	e8 46 f0 ff ff       	call   801038b0 <myproc>
...
80104873:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104876:	e8 35 f0 ff ff       	call   801038b0 <myproc>
  if(addr >= curproc->sz || addr+4 > curproc->sz)
...
801048b8:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
801048bb:	e8 f0 ef ff ff       	call   801038b0 <myproc>
...
80104950 <syscall>:
[SYS_getreadcount] sys_getreadcount,	// phase1
};
...
80104954:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
80104957:	e8 54 ef ff ff       	call   801038b0 <myproc>
...
80104967:	83 fa 15             	cmp    $0x15,%edx
8010496a:	77 1c                	ja     80104988 <syscall+0x38>
8010496c:	8b 14 85 c0 76 10 80 	mov    -0x7fef8940(,%eax,4),%edx
...
80104990:	68 91 76 10 80       	push   $0x80107691
...
80104ae4:	68 38 77 10 80       	push   $0x80107738
...
80104afc:	68 37 77 10 80       	push   $0x80107737
...
80104b15:	68 2b 77 10 80       	push   $0x8010772b
...
80104b2a:	68 3a 77 10 80       	push   $0x8010773a
80104b2f:	e8 5c b8 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80104b34:	83 ec 0c             	sub    $0xc,%esp
80104b37:	68 1c 77 10 80       	push   $0x8010771c
...
80104b74:	e8 37 ed ff ff       	call   801038b0 <myproc>
...
80104bb9:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80104bbb:	e8 f0 ec ff ff       	call   801038b0 <myproc>
...
80104c5a:	ff 75 ec             	pushl  -0x14(%ebp)
  readcnt++;	// added for getreadcount
80104c5d:	83 05 74 8f 11 80 01 	addl   $0x1,0x80118f74
  return fileread(f, p, n);
80104c64:	e8 f7 c2 ff ff       	call   80100f60 <fileread>
...
80104c80 <sys_getreadcount>:
{
80104c80:	55                   	push   %ebp
}
80104c81:	a1 74 8f 11 80       	mov    0x80118f74,%eax
{
...
80104c9b:	e8 b0 fe ff ff       	call   80104b50 <argfd.constprop.0>
...
80104d0c:	e8 3f fe ff ff       	call   80104b50 <argfd.constprop.0>
80104d11:	85 c0                	test   %eax,%eax
80104d13:	78 2b                	js     80104d40 <sys_close+0x40>
  myproc()->ofile[fd] = 0;
80104d15:	e8 96 eb ff ff       	call   801038b0 <myproc>
...
80104d5b:	e8 f0 fd ff ff       	call   80104b50 <argfd.constprop.0>
...
80104f39:	58                   	pop    %eax
80104f3a:	5a                   	pop    %edx
80104f3b:	68 38 77 10 80       	push   $0x80107738
...
80104f54:	68 37 77 10 80       	push   $0x80107737
...
8010514f:	0f 84 a6 00 00 00    	je     801051fb <sys_open+0x12b>
  struct proc *curproc = myproc();
80105155:	e8 56 e7 ff ff       	call   801038b0 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
801051cf:	e8 dc f7 ff ff       	call   801049b0 <create>
    if(ip == 0){
...
8010525f:	e8 4c f7 ff ff       	call   801049b0 <create>
...
801052ee:	e8 bd f6 ff ff       	call   801049b0 <create>
...
80105325:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
80105328:	e8 83 e5 ff ff       	call   801038b0 <myproc>
...
801054ff:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80105501:	e8 aa e3 ff ff       	call   801038b0 <myproc>
...
80105527:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  struct proc *curproc = myproc();
8010552a:	e8 81 e3 ff ff       	call   801038b0 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105561:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      myproc()->ofile[fd0] = 0;
80105568:	e8 43 e3 ff ff       	call   801038b0 <myproc>
...
801055a3:	5d                   	pop    %ebp
  return fork();
801055a4:	e9 a7 e4 ff ff       	jmp    80103a50 <fork>
...
801055b3:	83 ec 08             	sub    $0x8,%esp
  exit();
801055b6:	e8 35 e7 ff ff       	call   80103cf0 <exit>
...
801055c3:	5d                   	pop    %ebp
  return wait();
801055c4:	e9 67 e9 ff ff       	jmp    80103f30 <wait>
...
801055ee:	e8 9d ea ff ff       	call   80104090 <kill>
...
80105613:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80105616:	e8 95 e2 ff ff       	call   801038b0 <myproc>
...
80105637:	78 27                	js     80105660 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
80105639:	e8 72 e2 ff ff       	call   801038b0 <myproc>
  if(growproc(n) < 0)
...
80105646:	e8 85 e3 ff ff       	call   801039d0 <growproc>
...
80105690:	68 80 8f 11 80       	push   $0x80118f80
...
8010569d:	83 c4 10             	add    $0x10,%esp
  ticks0 = ticks;
801056a0:	8b 1d c0 97 11 80    	mov    0x801197c0,%ebx
  while(ticks - ticks0 < n){
...
801056b3:	68 80 8f 11 80       	push   $0x80118f80
801056b8:	68 c0 97 11 80       	push   $0x801197c0
801056bd:	e8 ae e7 ff ff       	call   80103e70 <sleep>
  while(ticks - ticks0 < n){
801056c2:	a1 c0 97 11 80       	mov    0x801197c0,%eax
...
801056cf:	73 2f                	jae    80105700 <sys_sleep+0x90>
    if(myproc()->killed){
801056d1:	e8 da e1 ff ff       	call   801038b0 <myproc>
...
801056e0:	68 80 8f 11 80       	push   $0x80118f80
...
80105703:	68 80 8f 11 80       	push   $0x80118f80
...
80105724:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105727:	68 80 8f 11 80       	push   $0x80118f80
8010572c:	e8 1f ed ff ff       	call   80104450 <acquire>
  xticks = ticks;
80105731:	8b 1d c0 97 11 80    	mov    0x801197c0,%ebx
  release(&tickslock);
80105737:	c7 04 24 80 8f 11 80 	movl   $0x80118f80,(%esp)
...
80105780:	8b 14 85 10 a0 10 80 	mov    -0x7fef5ff0(,%eax,4),%edx
80105787:	c7 04 c5 c2 8f 11 80 	movl   $0x8e000008,-0x7fee703e(,%eax,8)
8010578e:	08 00 00 8e 
80105792:	66 89 14 c5 c0 8f 11 	mov    %dx,-0x7fee7040(,%eax,8)
80105799:	80 
8010579a:	c1 ea 10             	shr    $0x10,%edx
8010579d:	66 89 14 c5 c6 8f 11 	mov    %dx,-0x7fee703a(,%eax,8)
801057a4:	80 
  for(i = 0; i < 256; i++)
...
801057af:	a1 10 a1 10 80       	mov    0x8010a110,%eax

  initlock(&tickslock, "time");
801057b4:	83 ec 08             	sub    $0x8,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
801057b7:	c7 05 c2 91 11 80 08 	movl   $0xef000008,0x801191c2
801057be:	00 00 ef 
  initlock(&tickslock, "time");
801057c1:	68 7d 77 10 80       	push   $0x8010777d
801057c6:	68 80 8f 11 80       	push   $0x80118f80
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
801057cb:	66 a3 c0 91 11 80    	mov    %ax,0x801191c0
801057d1:	c1 e8 10             	shr    $0x10,%eax
801057d4:	66 a3 c6 91 11 80    	mov    %ax,0x801191c6
  initlock(&tickslock, "time");
...
801057fb:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
801057ff:	b8 c0 8f 11 80       	mov    $0x80118fc0,%eax
...
80105850:	e8 5b e0 ff ff       	call   801038b0 <myproc>
...
80105870:	e8 1b e0 ff ff       	call   80103890 <cpuid>
...
80105881:	e8 2a e0 ff ff       	call   801038b0 <myproc>
80105886:	89 45 e0             	mov    %eax,-0x20(%ebp)
80105889:	e8 22 e0 ff ff       	call   801038b0 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
...
801058a5:	68 e0 77 10 80       	push   $0x801077e0
801058aa:	e8 b1 ad ff ff       	call   80100660 <cprintf>
            tf->err, cpuid(), tf->eip, rcr2());
    myproc()->killed = 1;
801058af:	83 c4 20             	add    $0x20,%esp
801058b2:	e8 f9 df ff ff       	call   801038b0 <myproc>
...
801058be:	e8 ed df ff ff       	call   801038b0 <myproc>
801058c3:	85 c0                	test   %eax,%eax
801058c5:	74 1d                	je     801058e4 <trap+0xc4>
801058c7:	e8 e4 df ff ff       	call   801038b0 <myproc>
...
801058e4:	e8 c7 df ff ff       	call   801038b0 <myproc>
801058e9:	85 c0                	test   %eax,%eax
801058eb:	74 0b                	je     801058f8 <trap+0xd8>
801058ed:	e8 be df ff ff       	call   801038b0 <myproc>
...
801058f6:	74 68                	je     80105960 <trap+0x140>
  ...
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
801058f8:	e8 b3 df ff ff       	call   801038b0 <myproc>
801058fd:	85 c0                	test   %eax,%eax
801058ff:	74 19                	je     8010591a <trap+0xfa>
80105901:	e8 aa df ff ff       	call   801038b0 <myproc>
...
8010599d:	e8 ae cd ff ff       	call   80102750 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
801059a2:	e8 09 df ff ff       	call   801038b0 <myproc>
...
801059bd:	e8 8e cd ff ff       	call   80102750 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
801059c2:	e8 e9 de ff ff       	call   801038b0 <myproc>
...
801059df:	e8 ac de ff ff       	call   80103890 <cpuid>
801059e4:	56                   	push   %esi
801059e5:	53                   	push   %ebx
801059e6:	50                   	push   %eax
801059e7:	68 88 77 10 80       	push   $0x80107788
...
801059f6:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
801059f9:	e8 b2 de ff ff       	call   801038b0 <myproc>
...
80105a1a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      exit();
80105a20:	e8 cb e2 ff ff       	call   80103cf0 <exit>
...
80105a43:	68 80 8f 11 80       	push   $0x80118f80
80105a48:	e8 03 ea ff ff       	call   80104450 <acquire>
      wakeup(&ticks);
80105a4d:	c7 04 24 c0 97 11 80 	movl   $0x801197c0,(%esp)
      ticks++;
80105a54:	83 05 c0 97 11 80 01 	addl   $0x1,0x801197c0
      wakeup(&ticks);
80105a5b:	e8 d0 e5 ff ff       	call   80104030 <wakeup>
      release(&tickslock);
80105a60:	c7 04 24 80 8f 11 80 	movl   $0x80118f80,(%esp)
...
80105a74:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105a77:	e8 14 de ff ff       	call   80103890 <cpuid>
...
80105a85:	68 ac 77 10 80       	push   $0x801077ac
80105a8a:	e8 d1 ab ff ff       	call   80100660 <cprintf>
      panic("trap");
80105a8f:	83 c4 14             	add    $0x14,%esp
80105a92:	68 82 77 10 80       	push   $0x80107782
...
{
  if(!uart)
80105aa0:	a1 c4 e5 10 80       	mov    0x8010e5c4,%eax
{
...
80105b77:	74 5a                	je     80105bd3 <uartinit+0xb3>
  uart = 1;
80105b79:	c7 05 c4 e5 10 80 01 	movl   $0x1,0x8010e5c4
80105b80:	00 00 00 
...
80105b8c:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105b8f:	bb a4 78 10 80       	mov    $0x801078a4,%ebx
  ioapicenable(IRQ_COM1, 0);
...
80105bb8:	74 19                	je     80105bd3 <uartinit+0xb3>
  if(!uart)
80105bba:	8b 15 c4 e5 10 80    	mov    0x8010e5c4,%edx
...
80105be0 <uartputc>:
  if(!uart)
80105be0:	8b 15 c4 e5 10 80    	mov    0x8010e5c4,%edx
{
...
8010679d:	68 ac 78 10 80       	push   $0x801078ac
...
80106853:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106856:	e8 35 d0 ff ff       	call   80103890 <cpuid>
...
8010686a:	c7 80 18 68 11 80 ff 	movl   $0xffff,-0x7fee97e8(%eax)
80106871:	ff 00 00 
80106874:	c7 80 1c 68 11 80 00 	movl   $0xcf9a00,-0x7fee97e4(%eax)
8010687b:	9a cf 00 
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
8010687e:	c7 80 20 68 11 80 ff 	movl   $0xffff,-0x7fee97e0(%eax)
80106885:	ff 00 00 
80106888:	c7 80 24 68 11 80 00 	movl   $0xcf9200,-0x7fee97dc(%eax)
8010688f:	92 cf 00 
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106892:	c7 80 28 68 11 80 ff 	movl   $0xffff,-0x7fee97d8(%eax)
80106899:	ff 00 00 
8010689c:	c7 80 2c 68 11 80 00 	movl   $0xcffa00,-0x7fee97d4(%eax)
801068a3:	fa cf 00 
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
801068a6:	c7 80 30 68 11 80 ff 	movl   $0xffff,-0x7fee97d0(%eax)
801068ad:	ff 00 00 
801068b0:	c7 80 34 68 11 80 00 	movl   $0xcff200,-0x7fee97cc(%eax)
801068b7:	f2 cf 00 
  lgdt(c->gdt, sizeof(c->gdt));
801068ba:	05 10 68 11 80       	add    $0x80116810,%eax
  pd[1] = (uint)p;
...
801068e0:	a1 c4 97 11 80       	mov    0x801197c4,%eax
{
...
8010692f:	e8 dc ce ff ff       	call   80103810 <mycpu>
80106934:	89 c6                	mov    %eax,%esi
80106936:	e8 d5 ce ff ff       	call   80103810 <mycpu>
8010693b:	89 c7                	mov    %eax,%edi
8010693d:	e8 ce ce ff ff       	call   80103810 <mycpu>
80106942:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106945:	83 c7 08             	add    $0x8,%edi
80106948:	e8 c3 ce ff ff       	call   80103810 <mycpu>
...
80106a79:	68 f1 78 10 80       	push   $0x801078f1
...
80106bdd:	68 29 79 10 80       	push   $0x80107929
...
80106d1c:	68 5d 79 10 80       	push   $0x8010795d
...
80106dbb:	a3 c4 97 11 80       	mov    %eax,0x801197c4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
80106def:	68 6e 79 10 80       	push   $0x8010796e
...
80106ed9:	68 92 79 10 80       	push   $0x80107992
80106ede:	e8 ad 94 ff ff       	call   80100390 <panic>
      panic("copyuvm: pte should exist");
80106ee3:	83 ec 0c             	sub    $0xc,%esp
80106ee6:	68 78 79 10 80       	push   $0x80107978
